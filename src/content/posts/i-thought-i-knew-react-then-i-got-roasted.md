...
pubDate: 2026-07-25
tags: ["react", "learning", "beginners", "ultralearning"]
---
...
My plan is to do code review exercises instead of just watching videos. The AI gives me a component with some issues — bugs, anti-patterns, things that work but _aren't ideal_ — and I try to find and explain what's wrong. It's faster than writing code from scratch, and it tests whether I actually understand the concepts or just recognize patterns. I haven't proven this approach works yet, but it feels like a better use of time than passively going through tutorials.
...
If you've been building with React but aren't sure you could explain it to someone else, try quizzing yourself. You might be surprised by what you don't actually know.

Have you ever caught yourself following patterns without understanding why they work?
