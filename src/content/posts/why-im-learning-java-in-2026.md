...
> **Update (August 2026):** This post is a decision record, and the decision has since changed. Cybersecurity is now my focus. I wrote about the pivot in [A Guide for Breaking Into Cybersecurity](https://adngx.com/posts/breaking-into-cybersecurity); the current direction is also on the [About page](/about).
